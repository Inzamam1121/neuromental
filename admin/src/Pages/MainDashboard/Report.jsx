                        ...
                        <div className=" mx-auto  overflow-x-auto font-pop w-[90%] via-gray-400">
                                <table className="min-w-full w-full overflow-x-scroll bg-gray11 border-separate  border-spacing-y-4 rounded-lg my-4 font-pop">
                                        ...
                                        <tbody>
                                                {data.map((row, index) => (
                                                        <tr
                                                                key={index} className="space-x-2 bg-white my-2 font-pop"
                                                                onClick={() => { navigate('/Admin/report/reportdetails') }}
                                                        >
                                                                <td className="py-6 rounded-l-xl px-4">
                                                                        <div className='font-pop flex items-center gap-3 w-[100%]'>
                                                                ...
                                                                <td className="py-2 px-4 font-pop">
                                                                        <div className={`${row.certificate == "issue" ? 'border-2 bg-[#63D5773B] text-[#63D577] border-[#63D577]' : row.status == "inprogress" ? 'border-2 bg-[#EBF4FE] text-[#3992F2] border-[#3992F2]' : ' border-2 border-[#63D577] rounded-r-lg rounded-l-lg font-pop text-[#63D577] w-22 pl-6  bg-[#EFFBF1]'} font-pop w-fit py-2 px-4 rounded-lg`}>
