...
const Profile = () => {
    return (
        <div className="w-[95%] m-auto flex flex-col lg:flex-row bg-white rounded-3xl">
            ...
            <div className="w-full lg:w-4/5 p-4">
                ...
                <div className="bg-[#F4F4F4] p-4 rounded-lg mb-5">
                    <div className='flex flex-col gap-4'>
                        <div className='flex flex-col md:flex-row gap-4 md:items-center'>
                            <div className="basis-[50%] flex-col md:flex-row flex gap-4 md:items-center ">
                                <label htmlFor="fname" className='text-[#7A7A7A] font-pop w-full max-w-[fit-content]'>Field<span className='text-red-600'>*</span></label>
                                <select name="" id="" className='text-[#7A7A7A] w-full py-3 px-4 shadow-shadow1 rounded-lg'>
                                    <option value="select" selected disabled>Select Field</option>
                                    <option value="male" selected disabled>Medical</option>
                                    <option value="Female" selected disabled>Computer Science</option>
                                </select>
                            </div>
                            <div className="basis-[50%] flex-col md:flex-row flex gap-4 md:items-center ">
                                <label htmlFor="fname" className='text-[#7A7A7A] font-pop w-full max-w-[fit-content]'>University<span className='text-red-600'>*</span></label>
                                <select name="" id="" className='text-[#7A7A7A] w-full py-3 px-4 shadow-shadow1 rounded-lg'>
                                    <option value="select" selected disabled>Select Course</option>
                                    <option value="male" selected disabled>Network</option>
                                    <option value="Female" selected disabled>Database</option>
                                </select>
                            </div>
                        </div>
                        <div className='flex flex-col md:flex-row gap-4 md:items-center'>
                            <div className='basis-[50%] flex-col md:flex-row flex gap-4 md:items-center'>
                                <label htmlFor="admission" className='text-[#7A7A7A] font-pop w-full max-w-[fit-content]'>End Date<span className='text-red-600'>*</span></label>
                                <input type="Date" id="admission" className='text-[#7A7A7A] w-full py-3 px-4 shadow-shadow1 rounded-lg' placeholder='Admission' />
                            </div>
                            <div className='basis-[50%] flex-col md:flex-row flex gap-4 md:items-center'>
                                <label htmlFor="admission" className='text-[#7A7A7A] font-pop w-full max-w-[fit-content]'>End Date<span className='text-red-600'>*</span></label>
                                <input type="Date" id="admission" className='text-[#7A7A7A] w-full py-3 px-4 shadow-shadow1 rounded-lg' placeholder='Admission' />
